...
type AddRequest struct {
	First  *int64 `thrift:"first,1,optional" frugal:"1,optional,i64" json:"first,omitempty"`
	Second *int64 `thrift:"second,2,optional" frugal:"2,optional,i64" json:"second,omitempty"`
}
...
var AddRequest_First_DEFAULT int64

func (p *AddRequest) GetFirst() (v int64) {
	if !p.IsSetFirst() {
		return AddRequest_First_DEFAULT
	}
	return *p.First
}

var AddRequest_Second_DEFAULT int64

func (p *AddRequest) GetSecond() (v int64) {
	if !p.IsSetSecond() {
		return AddRequest_Second_DEFAULT
	}
	return *p.Second
}
...
func (p *AddRequest) IsSetFirst() bool {
	return p.First != nil
}

func (p *AddRequest) IsSetSecond() bool {
	return p.Second != nil
}
...
type AddResponse struct {
	Sum *int64 `thrift:"sum,1,optional" frugal:"1,optional,i64" json:"sum,omitempty"`
}
...
var AddResponse_Sum_DEFAULT int64

func (p *AddResponse) GetSum() (v int64) {
	if !p.IsSetSum() {
		return AddResponse_Sum_DEFAULT
	}
	return *p.Sum
}
...
func (p *AddResponse) IsSetSum() bool {
	return p.Sum != nil
}
